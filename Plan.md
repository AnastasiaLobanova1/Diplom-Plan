...
| 9 б 	| Оплата тура несуществующей картой.<br>Описание: Заполнить поля данными (из пункта 2 раздела Исходные данные)                                                                               	| Вывод сообщения об ошибке.<br>В СУБД не должна сохраниться информация о платеже и данных карты                                                                                                                 	|
